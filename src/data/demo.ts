...
export const episodes: EpisodeBasic[] = [
  ...
  },
  {
    ...
    "whatYouLearn": "كيف تحدد أولوياتك الحقيقية بعيدًا عن ضغوط الآخرين، وكيف تقول لا بلباقة، وكيف تصمم روتينًا يدعم أهدافك.",
  ...
  },
  {
    ...
    "slug": "atomic-habits",
    "audioUrl": "/audio/atomic-habits-identity.m4a",
    "author": "جيمس كلير",
